...
> 💡 とくに **[Edusemi-v4x](https://samizo-aitl.github.io/Edusemi-v4x/)** は、**実務経験に基づく中核教材** です。
...
| 🧠 **[ChatGPT活用レベル診断](./about/chatgpt-skill-eval.md)** | **LLM活用スキル（Lv5.0）** の自己評価ツール |
...
- **薄膜ピエゾアクチュエータ（MEMS）**  
- **PrecisionCoreプリントヘッド** の構成管理・製品化・教育設計
