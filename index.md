...
| 🎛️ [EduController](https://samizo-aitl.github.io/EduController/) ＋ [SoC_DesignKit by ChatGPT](https://samizo-aitl.github.io/EduController/SoC_DesignKit_by_ChatGPT/README) | 制御理論からLLM統合・HDL設計までを網羅した9章構成教材。SoC DesignKitも内包 |
| 🤖 [AITL-H](https://samizo-aitl.github.io/AITL-H/) ＋ [PoCマニュアル（index.md）](https://samizo-aitl.github.io/AITL-H/docs/) | FSM（本能）＋PID（理性）＋LLM（知性）の三層制御構成をPoCで具現化 |
