...
| Date       | Description                                                                 |
|------------|-----------------------------------------------------------------------------|
| **2026-01-08** | **AITL Controller (A-Type) ― Official Architecture Definition & Reliability Boundary Specification published.**<br>• Official specification page fixed: https://samizo-aitl.github.io/aitl-controller-a-type/<br>• Positioned as the canonical AITL architecture reference (Architecture Canon). |
