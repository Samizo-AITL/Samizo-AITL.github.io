...
| Date       | Description                                                                 |
|------------|-----------------------------------------------------------------------------|
| **2026-01-03** | **Added Full Code Mechanical Design to the portal.**<br>・Clarified the position of Mechanical Design as Code independent of GUI-based CAD<br>・Placed immediately after inkjet-timing to freeze time-causal understanding into structural and boundary conditions<br>・Defined as a physical design foundation connecting multiphysics design to control and AITL |
