...
| Date       | Description                                                                 |
|------------|-----------------------------------------------------------------------------|
| **2026-01-22** | **Added design prerequisite and current-state documentation.**<br>・Structured the current state of Physical AI and AI control research from the perspectives of responsibility separation, time scales, and stability guarantees<br>・Explicitly fixed the prerequisite assumptions underlying the entire Samizo-AITL portal and AITL architecture as a snapshot document<br>・Published parallel Japanese and English versions under about/current/ to serve as a design prerequisite rather than a conceptual or philosophical statement |
| **2026-01-21** | **Technical Archive (Abstracted Engineering Knowledge) added.**<br>• Established an abstracted archive of manufacturing, reliability, and business continuity engineering knowledge<br>• Constructed a publishable archive without proprietary data, numerical conditions, or company/product names<br>• Added an Evaluation Matrix and Engineering Decision Frameworks<br>• Positioned the archive as an index of decision-making logic underpinning all materials and PoCs in the Samizo-AITL portal |
