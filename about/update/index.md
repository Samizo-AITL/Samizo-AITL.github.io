...
| 日付       | 内容 |
|------------|------|
| 2026-01-08 | **AITL Controller (A-Type) の公式アーキテクチャ定義および信頼性境界仕様を公開。**<br>・公式仕様ページを確定：https://samizo-aitl.github.io/aitl-controller-a-type/<br>・AITLの設計原典（Architecture Canon）として位置づけ |
