...
| Emoji | Category | File | Usage |
|---|---|---|---|
| 🔢 | Numbers | [numbers.md](numbers.md) | 数値、番号 |
| 🔣 | Symbols | [symbols.md](symbols.md) | 記号、補助 |
...
| 😀 | Emotion | [emotion.md](emotion.md) | 表情、反応 |
| 🎯 | Misc | [misc.md](misc.md) | 汎用 |
...
| Emoji | Category | File | Usage |
|---|---|---|---|
| 🧭 | Workflow | [workflow.md](workflow.md) | 作業フロー |
| 🔍 | Review | [review.md](review.md) | 確認、差分 |
| 🚀 | Deploy | [deploy.md](deploy.md) | 公開、更新 |
| 🔐 | Security | [security.md](security.md) | 保護、権限 |
| 📡 | Monitor | [monitor.md](monitor.md) | 監視、通知 |
| ⚠️ | Warning | [warning.md](warning.md) | 注意 |
| 🎛️ | Control | [control.md](control.md) | 操作、切替 |
| 🌐 | Network | [network.md](network.md) | 通信 |
| 🗄️ | Data | [data.md](data.md) | データ |
| 🤖 | AI | [ai.md](ai.md) | 自動化 |
| 🖥️ | UI | [ui.md](ui.md) | 画面 |
| 💾 | Storage | [storage.md](storage.md) | 保存 |
...
|---:|---|
| 1️⃣1️⃣0️⃣ | ひゃくとお | 警察 |
| 1️⃣1️⃣9️⃣ | いちいちきゅう | 消防／救急 |
| 1️⃣1️⃣9️⃣2️⃣ | いちいちきゅうに | 緊急事態 |
| 9️⃣1️⃣1️⃣ | ナインイレブン |
| 4️⃣0️⃣4️⃣ | Not Found |
...
| 7️⃣9️⃣4️⃣ | なくよ | 平安京 |
| 1️⃣1️⃣9️⃣2️⃣ | いい国 | 鎌倉 |
| 1️⃣2️⃣7️⃣4️⃣ | いにし | 文永の役 |
| 1️⃣2️⃣8️⃣1️⃣ | いにや | 弘安の役 |
| 1️⃣4️⃣6️⃣7️⃣ | ひとよ | 応仁の乱 |
| 1️⃣5️⃣4️⃣3️⃣ | 以後よ | 鉄砲伝来 |
| 1️⃣6️⃣0️⃣0️⃣ | ひろまる | 関ヶ原 |
| 1️⃣8️⃣6️⃣8️⃣ | ひとやろ | 明治 |
...
| Symbol | Image |
|---|---|
| Imperial Crest | <a href="flag/Imperial_Crest.png"><img src="flag/Imperial_Crest.png" width="40%"></a> |
| Rising Sun | <a href="flag/Rising_Sun.png"><img src="flag/Rising_Sun.png" width="30%"></a> |
